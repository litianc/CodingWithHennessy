...
import { Card, Input, Button, Typography, Space, Spin, Empty, Avatar, Tag, Tooltip } from 'antd'
import {
  SendOutlined,
  RobotOutlined,
  UserOutlined,
...
const ChatMessageItem: React.FC<ChatMessageItemProps> = ({ message, isLast = false }) => {
...
export const AIChat: React.FC<AIChatProps> = ({ meetingId }) => {
  ...
  const messages = chatHistory[meetingId] || []
